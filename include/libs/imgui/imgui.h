...
struct ImFont
{
    ...
    int MetricsTotalSurface;// 4     // out //            // Total getSurface in pixels to get an idea of the font rasterization/texture cost (not exact, we approximate the cost of padding between glyphs)
