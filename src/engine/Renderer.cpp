...
namespace Engine {
    ...
    void Renderer::recreateSwapChain() {
        ...
        if (swapChain == nullptr) {
            ...
            std::shared_ptr<Engine::SwapChain> oldSwapChain = std::move(swapChain);
            swapChain = std::make_unique<Engine::SwapChain>(device, extent, oldSwapChain);
    ...
    void Renderer::endFrame() {
        ...
        currentFrameIndex = (currentFrameIndex + 1) % Engine::SwapChain::MAX_FRAMES_IN_FLIGHT;
    }
